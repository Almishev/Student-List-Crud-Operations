...
public class StudentController {
    ...
    public String view(final Model model, @RequestParam int id) {
    ...
    public String edit(final Model model, @RequestParam int id) {
    ...
    public String delete(final Model model, @RequestParam int id) {
    ...
    public String deletion(final Model model, @RequestParam int id) {
